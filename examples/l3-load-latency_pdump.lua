...
function dpdk_available()
    -- Verifique se a biblioteca RTE DPDK está disponível
    -- Pode ser uma verificação de existência de uma função ou um arquivo de cabeçalho específico
    return true -- Ou false se não estiver disponível
end
